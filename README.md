...
5. Для каждой команды выберите ровно один режим:
   ...
   - **Изменяет состояние** запрашивает решение мастера и после одобрения сохраняет новое название и результат до явного сброса;
   - **Переход в другой терминал** запрашивает решение мастера, активирует выбранный терминал и добавляет на его корневой экран возврат назад.
