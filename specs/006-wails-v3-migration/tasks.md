...
- [ ] T076 Against the unchanged v2-free build candidate, rerun `go run ./cmd/build dev` launch/stop plus the T024 one-window/persistence, T032 lifecycle-trigger, and T037 local 4–7-player journeys, recording runtime/native results in `specs/006-wails-v3-migration/quickstart.md`
